...
# This written bash script is used to optimize the K Points 
# of cubic Mg scanning from 2 - 30 with increment of 2.
...
set output 'kp.ps'
set title 'Convergence test of K Points'
set xl 'Number of K Points'
